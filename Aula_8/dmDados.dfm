object dm: Tdm
  ...
  object stInsereVenda: TADOStoredProc
    Connection = conProjetoVenda
    ProcedureName = 'st_InsereVenda'
    Parameters = <
      item
        Name = '@RETURN_VALUE'
        DataType = ftInteger
  ...
  object stInsereItensVenda: TADOStoredProc
    Connection = conProjetoVenda
  ...
  object qryCodigoVenda: TADOQuery
    ...
    Left = 256
    Top = 176
    object qryCodigoVendaCOLUMN1: TIntegerField
      FieldName = 'COLUMN1'
      ReadOnly = True
    end
  end
  ...
  object qryRelat: TADOQuery
    ...
    SQL.Strings = (
      ...
      'ON TBPRODUTOS.ID_PROD = TBITENSVENDA.ID_Prod'
      'INNER JOIN TBCLIENTES'
      'ON TBCLIENTES.ID_CLI = TBVENDAS.ID_Cli')
    Left = 368
    Top = 176
  end
end
